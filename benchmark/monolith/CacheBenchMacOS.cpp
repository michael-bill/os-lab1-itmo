...
BENCHMARK_REGISTER_F(BaseFixture, RandomRead_Uncached)->Unit(benchmark::kMillisecond)->Iterations(1);
BENCHMARK_REGISTER_F(BaseFixture, MixedWorkload_Cached)->Unit(benchmark::kMillisecond)->Iterations(1);
BENCHMARK_REGISTER_F(BaseFixture, MixedWorkload_Uncached)->Unit(benchmark::kMillisecond)->Iterations(1);
...
BENCHMARK_REGISTER_F(BaseFixture, SequentialRead_Cached)->Unit(benchmark::kMillisecond)->Iterations(1);
BENCHMARK_REGISTER_F(BaseFixture, SequentialRead_Uncached)->Unit(benchmark::kMillisecond)->Iterations(1);
